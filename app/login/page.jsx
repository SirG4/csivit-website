      ...
      <div className="min-h-screen relative bg-[url('/Login/loginBack.png')] bg-no-repeat bg-cover bg-center">
        ...
        <div className='relative z-10 min-h-screen flex items-center justify-center p-6'>
          ...
          <div className='w-full max-w-2xl mt-10'>
            ...
            <h1 className='minercraft text-center  text-2xl m-2 shadow-2xl text-transparent bg-clip-text bg-gradient-to-b from-[#A9A9A9] to-[#848383]'>ENGINEERING IDEAS IN REALITY</h1>
              {/* Form */}
              <form onSubmit={handleSubmit} className='space-y-6'>
                ...
                <div className='animate-fade-in-left' style={{ animationDelay: '200ms' }}>
                  ...
                  <div className='relative'>
                    <FiMail size={22} className='absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400' />
                    <input
                      type="email"
                      name="email"
                ...
                <div className='animate-fade-in-left' style={{ animationDelay: '400ms' }}>
                  ...
                  <div className='relative'>
                    <FiLock size={22} className='absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400' />
                    <input
                ...
                <div className='grid grid-cols-2 gap-4 animate-fade-in-up' style={{ animationDelay: '1200ms' }}>
                  <button
                    type="button"
